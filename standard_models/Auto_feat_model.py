...
features = [item for item in data_nan.columns if target not in item 
                    if "Time" not in item 
                if "Viscos" not in item 
                if "NCO" not in item 
                if "QS2850_Supplier" not in item
                if "QS3250_Sampling_point" not in item
                if "QS3250_Product" not in item 
                if "QS3250_Grade" not in item
                if "QS2920_V" not in item
                if "QS3250_S" not in item
                if "diff" not in item
]
...
# -442.2435670166306
# -46867.234018 * log(BasonatT313003_1_PV)/QS3150_NCO_content_filled
# 9319.109141 * BasonatT301041_1_PV/QS3150_NCO_content_filled
# -242.347077 * exp(BasonatT301041_1_PV - QS3150_NCO_content_filled)
# 26.100604 * Basonat-T313003_1_PV
# -1.790095 * BasonatT301041_1_PV**3/BasonatT313003_1_PV
# -0.108515 * BasonatT301041_1_PV**2*QS3150_NCO_content_filled
# 0.044566 * exp(-BasonatT301041_1_PV + QS3150_NCO_content_filled)
# -0.000353 * BasonatT313003_1_PV*QS3150_NCO_content_filled**3
# 0.000048 * BasonatT301041_1_PV**2*QS3150_NCO_content_filled**3
